...
if __name__ == '__main__':
    ...
    if input == "1":
        ...
        print result.body.job_op.data.status 
        print result.body.job_op.data.options.value
        whoAmI = result.body.job_op.data.owner_id
    elif input == "2":        
...
#    ownerId = 123;
#    listcourseReq = buildListCourse(name_space, app_pb2.JobOperation.ADDJOB, ownerId)
