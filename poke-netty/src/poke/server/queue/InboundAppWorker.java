		...
		while (true) {
			...
			try {
				...
				if (msg instanceof Request) {
					...
					System.out.println("The req.getHeader is "+req.getHeader());
					System.out.println("The ResourceFactory is "+ResourceFactory.getInstance().resourceInstance(req.getHeader()));
					Request reply = null;
					if (rsc == null) {
